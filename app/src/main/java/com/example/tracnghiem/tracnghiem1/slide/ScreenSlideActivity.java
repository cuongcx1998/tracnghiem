...
import com.example.tracnghiem.tracnghiem1.cauhoi.CauHoiController;
...
public class ScreenSlideActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionController = new CauHoiController(this);
    ...
    public void result() {
        checkAns = 1;
        if (mPager.getCurrentItem() != 0) mPager.setCurrentItem(0);
